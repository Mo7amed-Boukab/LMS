...
import { User as UserIcon, Mail, Shield, Book, GraduationCap, Camera } from 'lucide-react';
import Header from '@/components/layout/Header';
import Footer from '@/components/layout/Footer';

export default function ProfilePage() {
    const { user, isLoading } = useAuth();
    const [activeTab, setActiveTab] = useState<'profile' | 'security' | 'learning'>('profile');
    ...
    if (!user) {
        return (
            <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center gap-4">
                ...
                <Link href="/login" className="text-red-700 hover:underline">Go to Login</Link>
            </div>
        );
    }
                        ...
                        <nav className="bg-white rounded-sm border border-gray-200 overflow-hidden">
                            <div className="p-2 space-y-1">
                                <button
                                    ...
                                    className={`w-full flex items-center gap-3 px-4 py-2.5 text-sm font-medium rounded-sm transition-colors text-left ${activeTab === 'profile'
                                ...
                                <button
                                    ...
                                    className={`w-full flex items-center gap-3 px-4 py-2.5 text-sm font-medium rounded-sm transition-colors text-left ${activeTab === 'security'
                                        ? "text-red-700 bg-red-50"
                                        : "text-gray-600 hover:bg-gray-50 hover:text-gray-900"
                                        }`}
                                >
                                ...
                                <button
                                    ...
                                    className={`w-full flex items-center gap-3 px-4 py-2.5 text-sm font-medium rounded-sm transition-colors text-left ${activeTab === 'learning'
                                        ? "text-red-700 bg-red-50"
                                        : "text-gray-600 hover:bg-gray-50 hover:text-gray-900"
                                        }`}
                                >
                            ...
                            <>
                                ...
                                <div className="bg-white rounded-sm border border-gray-200 p-6 sm:p-8">
                                    <div className="flex items-center justify-between mb-8">
                                        ...
                                        <button className="text-sm font-semibold text-red-700 hover:text-red-800 transition-colors">Edit</button>
                                    </div>
                                ...
                                {/* Preferences Section */}
                                <div className="bg-white rounded-sm border border-gray-200 p-6 sm:p-8">
                                    <h3 className="text-lg font-bold text-gray-900 mb-6">Account Preferences</h3>
                                    <div className="space-y-6">
                                        <div className="flex items-center justify-between">
                                            <div className="space-y-0.5">
                                                <p className="text-sm font-medium text-gray-900">Email Notifications</p>
                                                <p className="text-xs text-gray-500">Receive updates about your courses and progress.</p>
                                            </div>
                        ...
                        {activeTab === 'learning' && (
                            <div className="bg-white rounded-sm border border-gray-200 p-6 sm:p-8">
                                <div className="flex items-center justify-between mb-6">
                                    ...
                                    <Link href="/courses" className="text-sm font-medium text-red-700 hover:text-red-800 hover:underline">
                                        Browse Courses
                                    </Link>
                                </div>
                                <div className="text-center py-12">
                                    ...
                                    <h4 className="text-lg font-medium text-gray-900 mb-2">No enrollments yet</h4>
