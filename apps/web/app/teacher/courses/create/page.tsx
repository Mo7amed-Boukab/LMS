...
const categories = ["Design", "Development", "Marketing", "Data Science", "Business", "Finance"];
                    ...
                    <div className="absolute top-full left-0 right-0 mt-1 bg-white border border-gray-100 rounded shadow-lg z-20 py-1 max-h-60 overflow-y-auto">
                        {options.map((option) => (
                            <button
                                ...
                                className={`w-full text-left px-4 py-2 text-sm hover:bg-gray-50 flex items-center justify-between ${value === option ? "text-red-700 font-medium bg-red-50" : "text-gray-600"
                                    }`}
                            >
                                {option}
    ...
    const addLesson = (sectionId: number) => {
        setSections(sections.map(section => {
            if (section.id === sectionId) {
                return {
                    ...section,
                    lessons: [...section.lessons, { id: Date.now(), title: "New Lesson" }]
                };
            }
            return section;
        }));
                    ...
                    <div className="w-full lg:w-64 flex-shrink-0 lg:sticky lg:top-6">
                        <nav className="flex flex-row lg:flex-col gap-1 overflow-x-auto lg:overflow-visible pb-2 lg:pb-0">
                            <button
                                ...
                                className={`flex items-center gap-3 px-4 py-3 text-sm font-medium rounded whitespace-nowrap transition-colors w-full text-left ${activeTab === "basic" ? "bg-red-50 text-red-700" : "text-gray-600 hover:bg-gray-50"
                                    }`}
                            >
                                <Layout size={18} />
                                Basic Information
                            ...
                            <button
                                ...
                                className={`flex items-center gap-3 px-4 py-3 text-sm font-medium rounded whitespace-nowrap transition-colors w-full text-left ${activeTab === "curriculum" ? "bg-red-50 text-red-700" : "text-gray-600 hover:bg-gray-50"
                                    }`}
                            >
                                <List size={18} />
                                Curriculum
                            ...
                            <button
                                ...
                                className={`flex items-center gap-3 px-4 py-3 text-sm font-medium rounded whitespace-nowrap transition-colors w-full text-left ${activeTab === "media" ? "bg-red-50 text-red-700" : "text-gray-600 hover:bg-gray-50"
                                    }`}
                            >
                                <ImageIcon size={18} />
                                Media
                            ...
                            <button
                                ...
                                className={`flex items-center gap-3 px-4 py-3 text-sm font-medium rounded whitespace-nowrap transition-colors w-full text-left ${activeTab === "settings" ? "bg-red-50 text-red-700" : "text-gray-600 hover:bg-gray-50"
                                    }`}
                            >
                                <Settings size={18} />
                                Settings
                    ...
                    <div className="flex-1 w-full">
                        <div className="bg-white rounded border border-gray-200 p-6 lg:p-8 min-h-[600px]">
                            ...
                            {activeTab === "basic" && (
                                <div className="space-y-8 animate-in fade-in duration-300">
                                    <div className="border-b border-gray-100 pb-6">
                                        ...
                                        <p className="text-sm text-gray-500">Provide the fundamental details of your course to get started.</p>
                                    </div>
                                ...
                                <div className="space-y-8 animate-in fade-in duration-300">
                                    <div className="border-b border-gray-100 pb-6 flex flex-col sm:flex-row sm:items-end justify-between gap-4">
                                        <div>
                                            ...
                                            <p className="text-sm text-gray-500">Organize your course into sections and lessons.</p>
                                        </div>
                                        <button onClick={addSection} className="flex items-center gap-2 text-sm font-medium text-red-700 hover:text-red-800 px-4 py-2 rounded transition-colors">
                                    ...
                                    <div className="space-y-6 max-w-4xl">
                                        {sections.map((section, index) => (
                                            <div key={section.id} className="border border-gray-200 rounded overflow-hidden bg-gray-50/30">
                                                    ...
                                                    <div className="flex items-center gap-4 flex-1">
                                                        ...
                                                        <div className="flex-1">
                                                            <div className="flex items-center gap-2 mb-1">
                                                                <span className="text-xs font-bold text-gray-500 uppercase tracking-wider">Section {index + 1}</span>
                                                            </div>
                                                            <input
                                                                type="text"
                                                ...
                                                <div className="p-4 space-y-3">
                                                    {section.lessons.map((lesson, lIndex) => (
                                                        <div key={lesson.id} className="flex items-center justify-between p-3 bg-white border border-gray-200 rounded group hover:border-gray-300 transition-all">
                            ...
                            {activeTab === "media" && (
                                <div className="space-y-8 animate-in fade-in duration-300">
                                    <div className="border-b border-gray-100 pb-6">
                                        ...
                                        <p className="text-sm text-gray-500">Upload your course thumbnail and promotional video.</p>
                                    </div>
                                        ...
                                        <div>
                                            ...
                                            <div className="border-2 border-dashed border-gray-300 rounded p-10 flex flex-col items-center justify-center text-center hover:bg-gray-50 hover:border-gray-400 transition-all cursor-pointer group">
                                                <div className="p-4 bg-gray-100 rounded-full mb-4 group-hover:bg-white group-hover:shadow-sm transition-all">
                                                    <UploadCloud size={32} className="text-gray-500 group-hover:text-red-600" />
                                                </div>
                                                <p className="text-base font-medium text-gray-900 mb-1">Click to upload or drag and drop</p>
                                                <p className="text-sm text-gray-500">SVG, PNG, JPG or GIF (max. 800x600px)</p>
                                            </div>
                                        </div>

                                        <div>
                                            <label className="block text-sm font-semibold text-gray-700 mb-3">Promotional Video</label>
                            ...
                            {activeTab === "settings" && (
                                <div className="space-y-8 animate-in fade-in duration-300">
                                    <div className="border-b border-gray-100 pb-6">
                                        <h3 className="text-xl font-bold text-gray-900 mb-2">Course Settings</h3>
                                        <p className="text-sm text-gray-500">Configure pricing, visibility, and enrollment settings.</p>
                                    </div>
                                    ...
                                    <div className="space-y-8 max-w-4xl">
                                        <div>
                                            ...
                                            <p className="text-xs text-gray-500 mt-2">Leave blank or set to 0 for free courses.</p>
                                        </div>
                                        ...
                                        <div className="space-y-6">
                                            <div className="flex items-start justify-between p-4 border border-gray-200 rounded hover:border-gray-300 transition-colors bg-white">
                                                <div>
                                                    <h4 className="text-sm font-bold text-gray-900 mb-1">Public visibility</h4>
                                                    <p className="text-xs text-gray-500 max-w-md">Make this course visible to everyone in the catalogue and search results.</p>
                                                </div>
                                            ...
                                            <div className="flex items-start justify-between p-4 border border-gray-200 rounded hover:border-gray-300 transition-colors bg-white">
                                                <div>
                                                    <h4 className="text-sm font-bold text-gray-900 mb-1">Certificate of completion</h4>
                                                    <p className="text-xs text-gray-500 max-w-md">Issue certificates automatically to students upon successful completion.</p>
                                                </div>
                                                <label className="relative inline-flex items-center cursor-pointer mt-1">
