        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <Link href="/forgot-password" className="text-xs font-semibold text-red-700 hover:text-red-800 hover:underline">
                    Forgot password?
                  </Link>
                </div>
                <div className="relative">
            ...
            <div className="grid grid-cols-2 gap-3">
              {/* Facebook Button */}
              <button type="button" className="flex items-center justify-center gap-2 px-4 py-2.5 bg-white border border-gray-200 rounded-sm hover:bg-gray-50 hover:border-gray-300 transition-all">
            ...
            <p className="text-center text-sm text-gray-500">
              ...
              <Link href="/register" className="font-semibold text-red-700 hover:text-red-800 hover:underline transition-colors">
                Sign up
              </Link>
            </p>
          </form>
