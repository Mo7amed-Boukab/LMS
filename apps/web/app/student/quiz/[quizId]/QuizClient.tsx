          ...
          <div className="bg-white rounded border border-gray-100 overflow-hidden relative w-full">
            ...
            <div className="p-8 md:p-12">
               ...
               <p className="text-gray-600 mb-10 leading-relaxed text-lg">
                  Test your knowledge of variables, loops, and functions. You've got this! Ensure you have a stable internet connection before starting.
               </p>
               ...
               <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
                  <div className="bg-gray-50/50 p-6 rounded-xl flex flex-col items-center justify-center text-center gap-2 group hover:bg-red-50/10 transition-colors border border-transparent hover:border-red-100">
                     ...
                     <span className="text-2xl font-bold text-gray-900">{quiz.questions.length}</span>
                  ...
                  <div className="bg-gray-50/50 p-6 rounded-xl flex flex-col items-center justify-center text-center gap-2 group hover:bg-red-50/10 transition-colors border border-transparent hover:border-red-100">
                     ...
                     <span className="text-2xl font-bold text-gray-900">{quiz.timeLimit || 15}</span>
                  ...
                  <div className="bg-gray-50/50 p-6 rounded-xl flex flex-col items-center justify-center text-center gap-2 group hover:bg-red-50/10 transition-colors border border-transparent hover:border-red-100">
                     ...
                     <span className="text-2xl font-bold text-gray-900">{quiz.passingScore}%</span>
                     <span className="text-xs font-bold text-gray-400 uppercase tracking-widest">TO PASS</span>
                  </div>
               </div>
               ...
               <div className="space-y-6">
                  ...
                  <ul className="space-y-4 text-gray-600">
                     <li className="flex items-start gap-3">
                        ...
                        <span>This quiz consists of multiple-choice and code-completion questions designed to test practical application.</span>
                     </li>
                     <li className="flex items-start gap-3">
                        <div className="w-1.5 h-1.5 rounded-full bg-red-300 mt-2.5 flex-shrink-0" />
                        <span>You cannot pause the timer once you begin. Ensure you are in a distraction-free environment.</span>
                     </li>
                     <li className="flex items-start gap-3">
                        <div className="w-1.5 h-1.5 rounded-full bg-red-300 mt-2.5 flex-shrink-0" />
                        <span>Results will be displayed immediately after submission, along with detailed feedback on incorrect answers.</span>
                     </li>
                  </ul>
               </div>
      ...
      <header className="bg-white border-b border-gray-100 sticky top-0 z-10">
        <div className="max-w-5xl mx-auto px-4 h-16 flex items-center justify-between">
             ...
             <div className="hidden md:flex flex-col items-center">
                ...
                <span className="font-bold text-gray-900 text-sm line-clamp-1">{quiz.title}</span>
             </div>
      ...
      <main className="flex-1 max-w-5xl mx-auto w-full p-4 md:p-8 flex flex-col justify-center animate-in fade-in slide-in-from-bottom-4 duration-500">
           ...
           {question.options.map((option: any, index: number) => {
              ...
              return (
                 ...
                 >
                    ...
                    <div className={`w-8 h-8 rounded-full flex items-center justify-center font-medium text-base flex-shrink-0 transition-colors ${
                       isSelected 
        ...
        <div className="flex items-center justify-between mt-10">
           ...
           {currentIndex === quiz.questions.length - 1 ? (
             ...
             >
               {isSubmitting ? 'Submitting...' : 'Submit Quiz'} <CheckCircle2 size={15} />
             </button>
           ) : (
             <button
