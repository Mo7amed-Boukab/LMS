...
function TestimonialCard({ quote, name, role, avatar, offset }: TestimonialCardProps) {
    return (
        <div className={`bg-white/5 backdrop-blur-sm border border-white/10 p-6 rounded-lg hover:bg-white/10 transition-colors ${offset ? 'sm:translate-y-6' : ''}`}>
...
const testimonials = [
    {
        quote: "The practical projects in the UI/UX course were exactly what I needed to build my portfolio. I landed a job at a design agency two months after finishing!",
        name: "Sarah Jenkins",
        role: "Product Designer",
        avatar: "https://lh3.googleusercontent.com/aida-public/AB6AXuBwQpZ_z6VaahUhaC30dsRnWD3Dz8IONunNdE4hEpOHhis7U8MTgR55Z7BS6TOKjXQMYf3qMtMx-R7ggyDhab65wyvnl_6iywFWQy9lzAJt90ft8WDzi9FBjowSa1zM5bmMrz0pve7CX2a7NthZZ6Rp0YKa03wYYKSZuBcoFcHj47rI5cGkPl7jaEVYgY5ckug6dOtSnlo9u86eKxgpyE5iH2tQ31azVzvNye6i5DQBQIfp2I_dXI10YLYCNBZ7YE86I8TsV7cUZXnK",
    },
    {
        quote: "As a career switcher, I was intimidated by coding. The Python track was structured so well that I never felt lost. Highly recommend for beginners.",
        name: "Michael Torres",
        role: "Data Analyst",
        avatar: "https://lh3.googleusercontent.com/aida-public/AB6AXuAw-7vAvkXSFMHKE9qTjAAunsObmH2_c9sQKZ9k-GTOYv0p9ol75LkI4W0MFkBLhH2JDkOl95tptunOeTtG-r66neNO-TvLllgU8Ke3bT5OjM4pXgp3L0cri1FFMYIXqbqrpdmAPzTeSmspTtYISYl8_gV7l9vGW81Ysq7ZDO52cd0BZbjX1t7phry0iO7qgTP6i8dKdA44qGBtM42-gXcGmAtkowy10zl-SEyzsconYDoCSinVpAWmnFoCUfbfZf68YxfG2clhzDtq",
    },
];
                ...
                <div className="flex flex-col md:flex-row gap-12 items-center">
                    <div className="md:w-1/3">
                        ...
                        <p className="text-gray-400 text-lg mb-8">
                            Don&apos;t just take our word for it. Read how ED Academy has transformed careers worldwide.
                        </p>
