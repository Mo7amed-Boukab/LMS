...
const courses = [
  {
    category: "Business",
    imageUrl:
      "https://lh3.googleusercontent.com/aida-public/AB6AXuBTEffddOSEy9TzQWeEYXxRJyyJWa8xu-8luP0ynEbF1TY8eia0LUPcz3bqR_k5di6qDFwuYwAm-wmaVEdQArnvg4EoD71kUoXuQ6OoO9eIHmQomC67Bgy4OpSEHeWq3A38WHvm9dcVVThMyexYovioUMopJEAeQDtfY7w16c44YzTrvaN0K24eCfvVqfwPrYUmEA7ANd9S3OMKbRwg0a18m__YURF26qwPflMiIUmD4TR28LdaHkPVt6cI0fpdvj9jHfPW1xJyy0uM",
    rating: "4.8",
    reviewCount: "120",
    ...
    instructorAvatar:
      "https://lh3.googleusercontent.com/aida-public/AB6AXuAs0MLIvqVWoAD8vjo9-sei19vxotl5mo4rRx4tuKyUEt_ME7pg1j-A3JiB0aegZ83xNOoVprMcckS2waXSv8CpSmaEJaOEOoJeUThdN8BrLc14_hjJhpwoZA0j-L0rnZXKeai9pD-oPk3sBISseGjNZ19fZCjdaWkhyVg42HdM0N9r2i8pg7_VCSIlrPplAtlpGhvgiSd5Ri7veIza6H4cnczxnhc1J3Ar3zMMvsaYJtkLSkn0IjDHq_GWNkEb0NEj00xgHcup8yvf",
    price: "$49.99",
  ...
  },
  {
    category: "Design",
    imageUrl:
      "https://lh3.googleusercontent.com/aida-public/AB6AXuB7uNlJirx8Jxn14Rl5K7KlgCrBDtpBn_0aIlOLgHKixGnjsM8U5qdGMC7NAcBe5XP1QBJVj5VpMI_trnBDSTQLbQ6pTKnam_Pt0zrKCHmqN4JmQ54gbeJWCQagg_t4I37Rp-LncygVsEQXFMNOBYVS4O0bud1rXb-uTrBSUj-AUR0R3_W8BOHCAK4xeI-ifAwFOrSn9HD1TQVitKYqSHKlRVQ1kgzs0iC_aeInpAknIV8560FnBiNrgRmNZg-xSyDAjaNq5C3G6ytZ",
    rating: "4.9",
    reviewCount: "3.2k",
  ...
  },
  {
    category: "Business",
    imageUrl:
      "https://lh3.googleusercontent.com/aida-public/AB6AXuBv5ym9QlyfrP5_KdmYZPoSj-3aMNg97EKr2kuNWCm2DNkg-SBzYoOJolajU-bsT7MYf6sgLrBzBGNOJrdWIf24xhBS2hz4nnnk1nfHNK1wNPBhtjdW_hMmFseVnmUdOlQi8exNLtIgVZXqdmwaWHVEuk8cJl8X9uJn0-xaew2KctSoSo6M0rkiT4ZafrpwLJWu5hIzG0Mt23IIFJgerwA15dCUrRULlV1dFXHPeBo_tOfa0cyEoUG64pqvHGGvGMkwaE4jjG4GdhTb",
    rating: "4.6",
    reviewCount: "210",
  ...
  },
  {
    category: "Development",
    imageUrl:
      "https://lh3.googleusercontent.com/aida-public/AB6AXuAKPdl81Rsiejzx8021ceM9VES6y7ZUXGKnM0qyryXQoXiDUDXdEhjonq8id_0sRJtgMlUyPWaJ8f82YW9Jsj10IDZJC1DwlBYiHWLffB24rgPGvH53N9eh_mVLIoo6Dw-O1gy1_k0bnKdXPCDRUaqnnpNee3PKYOfXZSjdqIz47Os7hbV39XPkEd-970s4-DiYGboJL6fNzZxS26STViEv5YEpsR-CRhUk-1s64bCm8UrJQWGkYUZIC1oOmOjtkWSXJJ6prRBcIiUu",
    rating: "5.0",
    reviewCount: "15",
    ...
    instructorAvatar:
      "https://lh3.googleusercontent.com/aida-public/AB6AXuDyYEXL6R6xBsFyYp7gzjmZdhrCvjbyuBJVNvwptASJdzZOhhh-sI04sVvR-cWqheSU4_1SFZ271yo2nJ_JPJgVs8oZwuyfulbSNN_vYhg9Iyj1bgWDViYWQpIjdm_aeYfCbtDYBWmBVG6ZjJGSuYRxsHAD4R1x-22RZxYk0fHx_5a6rlB_EVC7tqm4OVxpBLP2hoTJIOB9NsoA3S4jE9OcyViruD8mNRRa_NiLYCZNoXOqDvt0im5th5-Pc5JpfOy5ypVswu9X5V7d",
    price: "$59.99",
  ...
  },
  {
    ...
    instructorAvatar:
      "https://lh3.googleusercontent.com/aida-public/AB6AXuAM4u0wSgMLsOaAOHVIZWqUrPRq47u_8N3aYF6KXEdn4AXBB3cmOmlEBDwsLGbU0ook1ADym6nJNJxXP3QoNMgnWCoK_lscUVeSHEGyTL06SNptWcoeE_exUsK4IZQS4Fs556Cfyj2XHdVA4svDIia_VEkfP3UHnqH62J4D1x7ZowDB5LRlV7s17PMt0UboANVn8DC25mmlfavRbLqRJccvn7106WexxNsE0abCaxWcgtKAV56Ki2lZpklSkpIqH2i_zmlC7umdM3-g",
    price: "$39.99",
  ...
  },
  {
    ...
    instructorAvatar:
      "https://lh3.googleusercontent.com/aida-public/AB6AXuBQo7D3SKZtC2cTKKPbIG-bJ75z7LXUWpV9A9UnNj_paYQCRsQ1IvWWksolRSIv5g1HO5twOb9TUxJb-k5EefGCyx1KnbjsBtkr6q94AHomieA0nQCsU5odUYmO9wBCpIO1f2RS9TPpnykd4mBXIZzoZRJv6rRHGYkFuPVB5TgZgeyV7zPLP6R-Xp6gu9fl89BgvH2ffW9BFElyM9_qRIPB3qeUWBDQRZJGgW5jPilK7hgYn9bEHvX46tW4OLpljXnvPeALpeZpg2xF",
    price: "$64.99",
          ...
          <div className="bg-white/95 border-b border-gray-100 px-6 py-6 md:px-10">
            <div className="max-w-[1370px] mx-auto">
              <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-4">
                <div>
                  <h1 className="text-[#1a1a1a] text-3xl font-bold tracking-tight">
                    Explore Courses
                  </h1>
                </div>
                <div className="flex items-center gap-3">
                  <span className="text-gray-500 text-sm font-medium whitespace-nowrap hidden sm:inline">
                    Sort by:
                  </span>
              ...
              <div className="flex flex-wrap gap-2 items-center">
                <span className="text-xs font-bold text-gray-500 mr-1 uppercase tracking-wide">
                  Active:
                </span>
                ...
                <div className="flex items-center gap-1.5 bg-[#f4f0f1] text-[#1a1a1a] border border-[#e6dbdd] rounded-full px-3 py-1 transition-colors hover:bg-[#e6dbdd] cursor-pointer group">
                  ...
                  <X
                    size={14}
                    className="text-gray-500 group-hover:text-[#1a1a1a]"
                  />
                </div>
                <button className="text-xs font-bold text-red-700 hover:underline ml-2">
                  Clear All
                </button>
              </div>
            </div>
          ...
          <div className="px-6 py-8 md:px-10 min-h-full">
            <div className="max-w-7xl mx-auto">
              <p className="text-gray-500 text-sm mb-6">
                Showing <span className="text-[#1a1a1a] font-bold">12</span> of{" "}
                <span className="text-[#1a1a1a] font-bold">148</span> results
              </p>
              ...
              <div className="flex justify-center mt-12">
                <nav className="flex items-center gap-2">
                  <a
                    className="flex items-center justify-center w-9 h-9 rounded border border-[#e6dbdd] text-gray-500 hover:bg-[#f4f0f1] hover:text-[#1a1a1a] transition-colors"
                    href="#"
                  >
                  ...
                  <a
                    className="flex items-center justify-center w-9 h-9 rounded bg-red-800 text-white font-small shadow-sm"
                    href="#"
                  >
                    1
                  </a>
                  <a
                    className="flex items-center justify-center w-9 h-9 rounded border border-[#e6dbdd] text-[#1a1a1a] font-small text-sm hover:bg-[#f4f0f1] transition-colors"
                    href="#"
                  >
                    2
                  </a>
