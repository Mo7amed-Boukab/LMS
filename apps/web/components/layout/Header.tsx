      ...
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between gap-16">
          ...
          <nav className="hidden md:flex items-center gap-8">
            <Link
              className="text-sm font-medium text-[#1a1a1a] hover:text-red-700 transition-colors"
              href="/"
            >
              Home
            </Link>
          ...
          <div className="flex flex-1 justify-end gap-6 items-center">
            ...
            {isAuthenticated ? (
              <div className="flex items-center gap-3">
                <Link
                  href="/profile"
                  className="hidden sm:flex items-center gap-2 text-sm font-medium text-[#1a1a1a] hover:bg-gray-100 py-2 px-3 rounded transition-colors"
                >
                  <UserIcon size={18} />
