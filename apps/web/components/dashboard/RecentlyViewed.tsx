...
const courses = [
  ...
  },
  {
    ...
    progress: 28,
    image:
      "https://images.unsplash.com/photo-1532094349884-543bc11b234d?w=200&auto=format&fit=crop&q=60",
  },
];
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-4 px-1">
        ...
        <a
          className="text-sm font-semibold text-primary hover:text-red-700 flex items-center gap-1"
          href="#"
        >
          View All{" "}
